...
(function (factory) {
        ...
        Menu.fn._renderTip = function ($menuItem) {
            ...
            if (!self.tipWidth) {
                ...
                editor.ready(function () {
                    var editor = this;
                    var titleWidth = $tempDiv.outerWidth() + 5;
                    // 多出 5px 的冗余
    ...
    _e(function (E, $) {
        ...
        DropList.fn.initDOM = function () {
            ...
            $.each(data, function (commandValue, title) {
                itemContent = tpl.replace(/{#commandValue}/gi, commandValue).replace(/{#title}/gi, title);
    ...
    _e(function (E, $) {
        ...
        DropPanel.fn._position = function () {
            ...
            // 下文用于和 marginLeft 比较，来设置三角形tip的位置
            ...
            // 设置三角形 tip 的位置
            $triangle.css({ 'margin-left': marginLeft2 - marginLeft - 5 });
        };
        // focus 第一个 input
    ...
    _e(function (E, $) {
        ...
        Txt.fn.bindEnterForDiv = function () {
            var tags = E.config.legalTags;
            // 配置中编辑器要求的合法标签，如 p head table blockquote ul ol 等
            var self = this;
            var editor = self.editor;
            var $txt = self.$txt;
            var $keydownDivElem;
                    ...
                    if (data && data.getData) {
                        ...
                        if (pasteHtml) {
                            ...
                            if (pasteHtml) {
                                ...
                                resultHtml = '<p>' + pasteHtml + '</p>';
                                // 查询链接
                                resultHtml = resultHtml.replace(/<p>(https?:\/\/.*?)<\/p>/gi, function (match, link) {
        ...
        Txt.fn.bindHtml = function () {
            ...
            $txt.html = function (html) {
                ...
                if (html === undefined) {
                    ...
                    result = result.replace(/(href|src)\=\"(.*)\"/gim, function (a, b, c) {
                        return b + '="' + c.replace('&amp;', '&') + '"';
                    });
                } else {
    ...
    _e(function (E, $) {
        ...
        // 表情包
        E.config.emotionsShow = 'icon';
        // 显示项，默认为'icon'，也可以配置成'value'
        E.config.emotions = {
            // 'default': {
            //     title: '默认',
            //     data: './emotions.data'
    ...
    _e(function (E, $) {
        E.createMenu(function (check) {
            ...
            editor.ready(function () {
                var editor = this;
                var $txt = editor.txt.$txt;
                var isPrevEnter = false;
                // 是不是刚刚在quote中按了 enter 键
                $txt.on('keydown', function (e) {
                    if (e.keyCode !== 13) {
                        // 不是 enter 键
                        isPrevEnter = false;
    ...
    _e(function (E, $) {
        ...
        E.createMenu(function (check) {
            ...
            mapData.loadMapScript = function () {
                ...
                script.src = 'https://api.map.baidu.com/api?v=2.0&ak=' + ak + '&s=1&callback=baiduMapCallBack';
                // baiduMapCallBack是一个本地函数
                try {
                    // IE10- 报错
    ...
    _e(function (E, $) {
        E.plugin(function () {
            ...
            // editor.config.uploadImgFns = {} 在config文件中定义了
            // -------- 定义load函数 --------
    ...
    _e(function (E, $) {
        ...
        E.plugin(function () {
            ...
            editor.xhrUploadImg = function (opt) {
                ...
                var fileType = opt.fileType || 'image/png';
                // 无扩展名则默认使用 png
    ...
    _e(function (E, $) {
        E.plugin(function () {
            ...
            function render() {
                ...
                isRender = true;
                $progress.css({ top: menuHeight + 'px' });
    ...
    _e(function (E, $) {
        ...
        UploadFile.fn.render = function () {
            ...
            self.$iframe = $iframe;
            // 生成 modal
            var modal = new E.Modal(editor, undefined, { $content: $container });
            self.modal = modal;
            // 记录
            self._hasRender = true;
        };
        ...
        UploadFile.fn.bindLoadEvent = function () {
            ...
            function onloadFn() {
                ...
                // 获取文件名
                var fileFullName = self.$input.val();
                // 结果如 C:\folder\abc.png 格式
            ...
            function bindToolbarEvent() {
                ...
                $alignLeft.click(function (e) {
                    commandFn = function () {
                        ...
                        $currentImg.parents('p').css({ 'text-align': 'left' }).attr('align', 'left');
                    };
                    customCommand(e, function () {
                        setTimeout(hide, 100);
                    });
                ...
                $alignRight.click(function (e) {
                    commandFn = function () {
                        // 如果 img 增加了链接，那么 img.parent() 就是 a 标签，设置 align 没用的，因此必须找到 P 父节点来设置 align
                        $currentImg.parents('p').css({ 'text-align': 'right' }).attr('align', 'right');
                    };
                    customCommand(e, function () {
                        setTimeout(hide, 100);
                    });
                ...
                $alignCenter.click(function (e) {
                    commandFn = function () {
                        // 如果 img 增加了链接，那么 img.parent() 就是 a 标签，设置 align 没用的，因此必须找到 P 父节点来设置 align
                        $currentImg.parents('p').css({ 'text-align': 'center' }).attr('align', 'center');
                    };
                    customCommand(e, function () {
                        setTimeout(hide, 100);
                    });
        ...
        E.plugin(function () {
            ...
            E.$window.scroll(function () {
                ...
                if (sTop >= menuTop && sTop + menuFixed + menuHeight + 30 < editorTop + editorHeight) {
                    ...
                    // 增加body margin-top
                    E.$body.css({ 'margin-top': bodyMarginTop + menuHeight });
                    // 记录
                    if (!editor._isMenufixed) {
                    ...
                    // 还原 body margin-top
                    E.$body.css({ 'margin-top': bodyMarginTop });
                    // 撤销记录
                    if (editor._isMenufixed) {
